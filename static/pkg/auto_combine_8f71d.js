...
;define('game-sign/index/index', function(require, exports, module){ var Ajax = require('common/ajax/index');
var Alert = require('common/alert/alert');
var Tabs = require('common/tabs/index');
var Bubble = require('common/bubble/bubble');

var prizeDeg = [80, 40, 360, 318, 278, 238, 200, 159, 119];
var awardTmpl = function(obj){
var __t,__p='',__j=Array.prototype.join,print=function(){__p+=__j.call(arguments,'');};
with(obj||{}){
__p+='<div id="J-award-panel" class="award-panel">\r\n\t<p class="award-msg">'+
((__t=( msg ))==null?'':__t)+
'</p>\r\n\t<p class="award-tip">'+
((__t=( tip ))==null?'':__t)+
'</p>\r\n\t<div class="btn-wrap">\r\n\t\t';
